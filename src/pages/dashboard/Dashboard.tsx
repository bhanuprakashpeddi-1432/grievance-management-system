...
import { Row, Col, Panel, Table, Badge, Progress, Stack, Divider, Button } from 'rsuite';
import { useNavigate } from 'react-router-dom';
import * as images from '../../images/charts';
import PieChart from './PieChart';
import { getRecentGrievances } from '../../data/grievances';
import './styles.less';
...
const Dashboard = () => {
  ...
  // Get recent grievances from shared data
  const recentGrievances = getRecentGrievances(5);
